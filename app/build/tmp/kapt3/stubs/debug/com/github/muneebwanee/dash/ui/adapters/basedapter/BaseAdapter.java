...
public abstract class BaseAdapter<T extends java.lang.Object, VH extends androidx.recyclerview.widget.RecyclerView.ViewHolder> extends androidx.recyclerview.widget.RecyclerView.Adapter<VH> implements com.github.muneebwanee.dash.ui.adapters.basedapter.BaseInterfaceAdapter<T> {
    ...
    com.github.muneebwanee.dash.ui.adapters.basedapter.FirebaseOptions<T> options) {
        super();
    }
